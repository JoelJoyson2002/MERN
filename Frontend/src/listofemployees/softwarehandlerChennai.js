...
import '../pages/softwarehandlerChennai.css';
import { useDispatch, useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getEmployees } from '../actions/employeesActions';
import SoftwareHandlerChennaiPartition from '../partitions/softwarehandlerChennaiPartition';
...
const SoftwarehandlerChennai=()=>{
  ...
  const {employee_details,loading}=useSelector((state)=>
    ...
    const filtered = employee_details.filter(
      (obj) => obj.service_type === 'softwarehandler' && obj.location === 'Chennai'
    );
...
<MetaData title={'chooseProvider'}/>
  ...
  <div className='partition-container'>
    ...
    <div className="partition-1">
             ...
             <img src="/images/softwarehandlerChennai-1.jpg" className="image2" alt ="not found"></img>
             <span className="name">Mr.Evans</span><br></br>
             <span className="age">age:31</span><br></br>
             <div class="rating">
  <div class="star-151">&#9733;</div> 
  <div class="star-152">&#9733;</div>
  <div class="star-153">&#9733;</div>
  <div class="star-154">&#9733;</div>
  <div class="star-155">&#9733;</div>
</div>
    ...
    <div className="partition-2">
             ...
             <img src="/images/softwarehandlerChennai-2.jpg" className="image3" alt ="not found"></img>
             <span className="name">Mr.Bruce</span><br></br>
             <span className="age">age:32</span><br></br>
             <div class="rating-2">
  <div class="star-156">&#9733;</div> 
  <div class="star-157">&#9733;</div>
  <div class="star-158">&#9733;</div>
  <div class="star-159">&#9733;</div>
  <div class="star-160">&#9733;</div>
</div>
    ...
    <div className="partition-3">
             ...
             <img src="/images/softwareHandlerChennai-3.jpg" className="image4" alt ="not found"></img>
             <span className="name">Mr.Mcqueen</span><br></br>
             <span className="age">age:30</span><br></br>
             <div class="rating-3">
  <div class="star-161">&#9733;</div> 
  <div class="star-162">&#9733;</div>
  <div class="star-163">&#9733;</div>
  <div class="star-164">&#9733;</div>
  <div class="star-165">&#9733;</div>
</div>
...
<div className="partition-container">
        {filtered.map((plumber, index) => (
          <SoftwareHandlerChennaiPartition key={index} plumber={plumber} />
        ))}
      </div>
    </div>
  );
...
export default SoftwarehandlerChennai;