...
import '../pages/pestcontrolKolkata.css';
import { useDispatch, useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getEmployees } from '../actions/employeesActions';
import PestControlKolkataPartition from '../partitions/pestcontrolKolkataPartition';
...
const PestcontrolKolkata=()=>{
  ...
  const {employee_details,loading}=useSelector((state)=>
    ...
    const filtered = employee_details.filter(
      (obj) => obj.service_type === 'pestcontroller' && obj.location === 'Kolkata'
    );
...
<MetaData title={'chooseProvider'}/>
  ...
  <div className='partition-container'>
    ...
    <div className="partition-1">
             ...
             <img src="/images/pestcontrolKolkata-1.jpg" className="image2" alt ="not found"></img>
             <span className="name">Mr.Evans</span><br></br>
             <span className="age">age:31</span><br></br>
             <div class="rating">
  <div class="star-346">&#9733;</div> 
  <div class="star-347">&#9733;</div>
  <div class="star-348">&#9733;</div>
  <div class="star-349">&#9733;</div>
  <div class="star-350">&#9733;</div>
</div>
    ...
    <div className="partition-2">
             ...
             <img src="/images/pestcontrolKolkata-2.jpg" className="image3" alt ="not found"></img>
             <span className="name">Mr.Bruce</span><br></br>
             <span className="age">age:32</span><br></br>
             <div class="rating-2">
  <div class="star-351">&#9733;</div> 
  <div class="star-352">&#9733;</div>
  <div class="star-353">&#9733;</div>
  <div class="star-354">&#9733;</div>
  <div class="star-355">&#9733;</div>
</div>
    ...
    <div className="partition-3">
             ...
             <img src="/images/pestcontrolKolkata-3.jpg" className="image4" alt ="not found"></img>
             <span className="name">Mr.Poorna</span><br></br>
             <span className="age">age:30</span><br></br>
             <div class="rating-3">
  <div class="star-356">&#9733;</div> 
  <div class="star-357">&#9733;</div>
  <div class="star-358">&#9733;</div>
  <div class="star-359">&#9733;</div>
  <div class="star-360">&#9733;</div>
</div>
...
<div className="partition-container">
        {filtered.map((plumber, index) => (
          <PestControlKolkataPartition key={index} plumber={plumber} />
        ))}
      </div>
    </div>
  );
...
export default PestcontrolKolkata;