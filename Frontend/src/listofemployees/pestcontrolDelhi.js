...
import '../pages/pestcontrolDelhi.css';
import { useDispatch, useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getEmployees } from '../actions/employeesActions';
import PestControlDelhiPartition from '../partitions/pestcontrolDelhiPartition';
...
const PestcontrolDelhi=()=>{
  ...
  const {employee_details,loading}=useSelector((state)=>
    ...
    const filtered = employee_details.filter(
      (obj) => obj.service_type === 'pestcontroller' && obj.location === 'Delhi'
    );
...
{/*
  <div className='partition-container'>
    ...
    <div className="partition-1">
             ...
             <img src="/images/pestcontrolDelhi-1.jpg" className="image2" alt ="not found"></img>
             <span className="name">Mr.Evans</span><br></br>
             <span className="age">age:31</span><br></br>
             <div class="rating">
  <div class="star-331">&#9733;</div> 
  <div class="star-332">&#9733;</div>
  <div class="star-333">&#9733;</div>
  <div class="star-334">&#9733;</div>
  <div class="star-335">&#9733;</div>
</div>
    ...
    <div className="partition-2">
             ...
             <img src="/images/pestcontrolDelhi-2.jpg" className="image3" alt ="not found"></img>
             <span className="name">Mr.Bruce</span><br></br>
             <span className="age">age:32</span><br></br>
             <div class="rating-2">
  <div class="star-336">&#9733;</div> 
  <div class="star-337">&#9733;</div>
  <div class="star-338">&#9733;</div>
  <div class="star-339">&#9733;</div>
  <div class="star-340">&#9733;</div>
</div>
    ...
    <div className="partition-3">
             ...
             <img src="/images/pestcontrolDelhi-3.jpg" className="image4" alt ="not found"></img>
             <span className="name">Mr.Poorna</span><br></br>
             <span className="age">age:30</span><br></br>
             <div class="rating-3">
  <div class="star-341">&#9733;</div> 
  <div class="star-342">&#9733;</div>
  <div class="star-343">&#9733;</div>
  <div class="star-344">&#9733;</div>
  <div class="star-345">&#9733;</div>
</div>
...
<div className="partition-container">
        {filtered.map((plumber, index) => (
          <PestControlDelhiPartition key={index} plumber={plumber} />
        ))}
      </div>
    </div>
  );
...
export default PestcontrolDelhi;