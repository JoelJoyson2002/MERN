...
import '../pages/electricalChennai.css';
import { useDispatch, useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getEmployees } from '../actions/employeesActions';
import ElectricalChennaiPartition from '../partitions/electricalChennaiPartition';
...
const ElectricalChennai=()=>{
  ...
  const {employee_details,loading}=useSelector((state)=>
    ...
    const filtered = employee_details.filter(
      (obj) => obj.service_type === 'electrician' && obj.location === 'Chennai'
    );
...
<MetaData title={'chooseProvider'}/>
  ...
  <div className='partition-container'>
    ...
    <div className="partition-1">
             ...
             <img src="/images/electricianChennai-1.jpg" className="image2" alt ="not found"></img>
             <span className="name">Mr.Evans</span><br></br>
             <span className="age">age:31</span><br></br>
             <div class="rating">
  <div class="star-76">&#9733;</div> 
  <div class="star-77">&#9733;</div>
  <div class="star-78">&#9733;</div>
  <div class="star-79">&#9733;</div>
  <div class="star-80">&#9733;</div>
</div>
    ...
    <div className="partition-2">
             ...
             <img src="/images/electricianChennai-2.jpg" className="image3" alt ="not found"></img>
             <span className="name">Mr.Bruce</span><br></br>
             <span className="age">age:32</span><br></br>
             <div class="rating-2">
  <div class="star-81">&#9733;</div> 
  <div class="star-82">&#9733;</div>
  <div class="star-83">&#9733;</div>
  <div class="star-84">&#9733;</div>
  <div class="star-85">&#9733;</div>
</div>
    ...
    <div className="partition-3">
             ...
             <img src="/images/electricianChennai-3.jpg" className="image4" alt ="not found"></img>
             <span className="name">Mr.Mcqueen</span><br></br>
             <span className="age">age:30</span><br></br>
             <div class="rating-3">
  <div class="star-86">&#9733;</div> 
  <div class="star-87">&#9733;</div>
  <div class="star-88">&#9733;</div>
  <div class="star-89">&#9733;</div>
  <div class="star-90">&#9733;</div>
</div>
...
<div className="partition-container">
        {filtered.map((plumber, index) => (
          <ElectricalChennaiPartition key={index} plumber={plumber} />
        ))}
      </div>
    </div>
  );
...
export default ElectricalChennai;