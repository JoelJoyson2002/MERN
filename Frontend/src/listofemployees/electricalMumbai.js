...
import '../pages/electricalMumbai.css';
import { useDispatch, useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getEmployees } from '../actions/employeesActions';
import ElectricalMumbaiPartition from '../partitions/electricalMumbaiPartition';
...
const ElectricalMumbai=()=>{
  ...
  const {employee_details,loading}=useSelector((state)=>
    ...
    const filtered = employee_details.filter(
      (obj) => obj.service_type === 'electrician' && obj.location === 'Mumbai'
    );
...
<MetaData title={'chooseProvider'}/>
  ...
  <div className='partition-container'>
    ...
    <div className="partition-1">
             ...
             <img src="/images/electricianMumbai-1.jpg" className="image2" alt ="not found"></img>
             <span className="name">Mr.Evans</span><br></br>
             <span className="age">age:31</span><br></br>
             <div class="rating">
  <div class="star-91">&#9733;</div> 
  <div class="star-92">&#9733;</div>
  <div class="star-93">&#9733;</div>
  <div class="star-94">&#9733;</div>
  <div class="star-95">&#9733;</div>
</div>
    ...
    <div className="partition-2">
             ...
             <img src="/images/electricianMumbai-2.jpg" className="image3" alt ="not found"></img>
             <span className="name">Mr.Bruce</span><br></br>
             <span className="age">age:32</span><br></br>
             <div class="rating-2">
  <div class="star-96">&#9733;</div> 
  <div class="star-97">&#9733;</div>
  <div class="star-98">&#9733;</div>
  <div class="star-99">&#9733;</div>
  <div class="star-100">&#9733;</div>
    ...
    <div className="partition-3">
             ...
             <img src="/images/electricianMumbai-3.jpg" className="image4" alt ="not found"></img>
             <span className="name">Mr.Mcqueen</span><br></br>
             <span className="age">age:30</span><br></br>
             <div class="rating-3">
  <div class="star-101">&#9733;</div> 
  <div class="star-102">&#9733;</div>
  <div class="star-103">&#9733;</div>
  <div class="star-104">&#9733;</div>
  <div class="star-105">&#9733;</div>
</div>
...
<div className="partition-container">
        {filtered.map((plumber, index) => (
          <ElectricalMumbaiPartition key={index} plumber={plumber} />
        ))}
      </div>
    </div>
  );
...
export default ElectricalMumbai;