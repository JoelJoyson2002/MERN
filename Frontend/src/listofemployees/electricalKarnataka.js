...
import '../pages/electricalKarnataka.css';
import { useDispatch, useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getEmployees } from '../actions/employeesActions';
import ElectricalKarnatakaPartition from '../partitions/electricalKarnatakaPartition';
...
const ElectricalKarnataka=()=>{
  ...
  const {employee_details,loading}=useSelector((state)=>
    ...
    const filtered = employee_details.filter(
      (obj) => obj.service_type === 'electrician' && obj.location === 'Karnataka'
    );
...
<MetaData title={'chooseProvider'}/>
  ...
  <div className='partition-container'>
    ...
    <div className="partition-1">
             ...
             <img src="/images/electricianKarnataka-1.jpg" className="image2" alt ="not found"></img>
             <span className="name">Mr.Evans</span><br></br>
             <span className="age">age:31</span><br></br>
             <div class="rating">
  <div class="star-136">&#9733;</div> 
  <div class="star-137">&#9733;</div>
  <div class="star-138">&#9733;</div>
  <div class="star-139">&#9733;</div>
  <div class="star-140">&#9733;</div>
</div>
    ...
    <div className="partition-2">
             ...
             <img src="/images/electricianKarnataka-2.jpg" className="image3" alt ="not found"></img>
             <span className="name">Mr.Bruce</span><br></br>
             <span className="age">age:32</span><br></br>
             <div class="rating-2">
  <div class="star-141">&#9733;</div> 
  <div class="star-142">&#9733;</div>
  <div class="star-143">&#9733;</div>
  <div class="star-144">&#9733;</div>
  <div class="star-145">&#9733;</div>
</div>
    ...
    <div className="partition-3">
             ...
             <img src="/images/electricianKarnataka-3.jpg" className="image4" alt ="not found"></img>
             <span className="name">Mr.Mcqueen</span><br></br>
             <span className="age">age:30</span><br></br>
             <div class="rating-3">
  <div class="star-146">&#9733;</div> 
  <div class="star-147">&#9733;</div>
  <div class="star-148">&#9733;</div>
  <div class="star-149">&#9733;</div>
  <div class="star-150">&#9733;</div>
</div>
...
<div className="partition-container">
        {filtered.map((plumber, index) => (
          <ElectricalKarnatakaPartition key={index} plumber={plumber} />
        ))}
      </div>
    </div>
  );
...
export default ElectricalKarnataka;