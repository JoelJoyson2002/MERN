...
import '../pages/cleaningKolkata.css';
import { useDispatch, useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getEmployees } from '../actions/employeesActions';
import CleaningKolkataPartition from '../partitions/cleaningKolkataPartition';
...
const CleaningKolkata=()=>{
  ...
  const {employee_details,loading}=useSelector((state)=>
    ...
    const filtered = employee_details.filter(
      (obj) => obj.service_type === 'cleaner' && obj.location === 'Kolkata'
    );
...
<MetaData title={'chooseProvider'}/>
  ...
  <div className='partition-container'>
    ...
    <div className="partition-1">
             ...
             <img src="/images/cleanerKolkata-1.jpg" className="image2" alt ="not found"></img>
             <span className="name">Mr.Evans</span><br></br>
             <span className="age">age:31</span><br></br>
             <div class="rating">
  <div class="star-271">&#9733;</div> 
  <div class="star-272">&#9733;</div>
  <div class="star-273">&#9733;</div>
  <div class="star-274">&#9733;</div>
  <div class="star-275">&#9733;</div>
</div>
    ...
    <div className="partition-2">
             ...
             <img src="/images/cleanerKolkata-2.jpg" className="image3" alt ="not found"></img>
             <span className="name">Mr.Bruce</span><br></br>
             <span className="age">age:32</span><br></br>
             <div class="rating-2">
  <div class="star-276">&#9733;</div> 
  <div class="star-277">&#9733;</div>
  <div class="star-278">&#9733;</div>
  <div class="star-279">&#9733;</div>
  <div class="star-280">&#9733;</div>
</div>
    ...
    <div className="partition-3">
             ...
             <img src="/images/cleanerKolkata-3.jpg" className="image4" alt ="not found"></img>
             <span className="name">Mr.Poorna</span><br></br>
             <span className="age">age:30</span><br></br>
             <div class="rating-3">
  <div class="star-281">&#9733;</div> 
  <div class="star-282">&#9733;</div>
  <div class="star-283">&#9733;</div>
  <div class="star-284">&#9733;</div>
  <div class="star-285">&#9733;</div>
</div>
...
<div className="partition-container">
        {filtered.map((plumber, index) => (
          <CleaningKolkataPartition key={index} plumber={plumber} />
        ))}
      </div>
    </div>
  );
...
export default CleaningKolkata;