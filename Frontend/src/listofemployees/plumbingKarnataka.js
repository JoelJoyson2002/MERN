...
import '../pages/plumbingKarnataka.css';
import { useDispatch, useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getEmployees } from '../actions/employeesActions';
import PlumberKarnatakaPartition from '../partitions/plumberKarnatakaPartition';
...
const PlumbingKarnataka=()=>{
  ...
  const {employee_details,loading}=useSelector((state)=>
    ...
    const filtered = employee_details.filter(
      (obj) => obj.service_type === 'plumber' && obj.location === 'Karnataka'
    );
...
<MetaData title={'chooseProvider'}/>
  ...
  <div className='partition-container'>
    ...
    <div className="partition-1">
             ...
             <div class="rating">
  <div class="star-61">&#9733;</div> 
  <div class="star-62">&#9733;</div>
  <div class="star-63">&#9733;</div>
  <div class="star-64">&#9733;</div>
  <div class="star-65">&#9733;</div>
</div>
    ...
    <div className="partition-2">
             ...
             <div class="rating-2">
  <div class="star-66">&#9733;</div> 
  <div class="star-67">&#9733;</div>
  <div class="star-68">&#9733;</div>
  <div class="star-69">&#9733;</div>
  <div class="star-70">&#9733;</div>
</div>
    ...
    <div className="partition-3">
             ...
             <div class="rating-3">
  <div class="star-71">&#9733;</div> 
  <div class="star-72">&#9733;</div>
  <div class="star-73">&#9733;</div>
  <div class="star-74">&#9733;</div>
...
<div className="partition-container">
        {filtered.map((plumber, index) => (
          <PlumberKarnatakaPartition key={index} plumber={plumber} />
        ))}
      </div>
    </div>
  );
...
export default PlumbingKarnataka;