...
import '../pages/softwarehandlerDelhi.css';
import { useDispatch, useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getEmployees } from '../actions/employeesActions';
import SoftwareHandlerDelhiPartition from '../partitions/softwarehandlerDelhiPartition';
...
const SoftwarehandlerDelhi=()=>{
  ...
  const {employee_details,loading}=useSelector((state)=>
    ...
    const filtered = employee_details.filter(
      (obj) => obj.service_type === 'softwarehandler' && obj.location === 'Delhi'
    );
...
<MetaData title={'chooseProvider'}/>
  ...
  <div className='partition-container'>
    ...
    <div className="partition-1">
             ...
             <img src="/images/softwarehandlerDelhi-1.jpg" className="image2" alt ="not found"></img>
             <span className="name">Mr.Evans</span><br></br>
             <span className="age">age:31</span><br></br>
             <div class="rating">
  <div class="star-181">&#9733;</div> 
  <div class="star-182">&#9733;</div>
  <div class="star-183">&#9733;</div>
  <div class="star-184">&#9733;</div>
  <div class="star-185">&#9733;</div>
</div>
    ...
    <div className="partition-2">
             ...
             <img src="/images/softwarehandlerDelhi-2.jpg" className="image3" alt ="not found"></img>
             <span className="name">Mr.Bruce</span><br></br>
             <span className="age">age:32</span><br></br>
             <div class="rating-2">
  <div class="star-186">&#9733;</div> 
  <div class="star-187">&#9733;</div>
  <div class="star-188">&#9733;</div>
  <div class="star-189">&#9733;</div>
  <div class="star-190">&#9733;</div>
</div>
    ...
    <div className="partition-3">
             ...
             <img src="/images/softwareHandlerDelhi-3.jpg" className="image4" alt ="not found"></img>
             <span className="name">Mr.Poorna</span><br></br>
             <span className="age">age:30</span><br></br>
             <div class="rating-3">
  <div class="star-191">&#9733;</div> 
  <div class="star-192">&#9733;</div>
  <div class="star-193">&#9733;</div>
  <div class="star-194">&#9733;</div>
  <div class="star-195">&#9733;</div>
</div>
...
<div className="partition-container">
        {filtered.map((plumber, index) => (
          <SoftwareHandlerDelhiPartition key={index} plumber={plumber} />
        ))}
      </div>
    </div>
  );
...
export default SoftwarehandlerDelhi;