...
import '../pages/pestcontrolChennai.css';
import { useDispatch, useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getEmployees } from '../actions/employeesActions';
import PestControlChennaiPartition from '../partitions/pestcontrolChennaiPartition';
...
const PestcontrolChennai=()=>{
  ...
  const {employee_details,loading}=useSelector((state)=>
    ...
    const filtered = employee_details.filter(
      (obj) => obj.service_type === 'pestcontroller' && obj.location === 'Chennai'
    );
...
{/*
  <div className='partition-container'>
    ...
    <div className="partition-1">
             ...
             <img src="/images/pestcontrolChennai-1.jpg" className="image2" alt ="not found"></img>
             <span className="name">Mr.Evans</span><br></br>
             <span className="age">age:31</span><br></br>
             <div class="rating">
  <div class="star-301">&#9733;</div> 
  <div class="star-302">&#9733;</div>
  <div class="star-303">&#9733;</div>
  <div class="star-304">&#9733;</div>
  <div class="star-305">&#9733;</div>
</div>
    ...
    <div className="partition-2">
             ...
             <img src="/images/pestcontrolChennai-2.jpg" className="image3" alt ="not found"></img>
             <span className="name">Mr.Bruce</span><br></br>
             <span className="age">age:32</span><br></br>
             <div class="rating-2">
  <div class="star-306">&#9733;</div> 
  <div class="star-307">&#9733;</div>
  <div class="star-308">&#9733;</div>
  <div class="star-309">&#9733;</div>
  <div class="star-310">&#9733;</div>
</div>
    ...
    <div className="partition-3">
             ...
             <img src="/images/pestcontrolChennai-3.jpg" className="image4" alt ="not found"></img>
             <span className="name">Mr.Poorna</span><br></br>
             <span className="age">age:30</span><br></br>
             <div class="rating-3">
  <div class="star-311">&#9733;</div> 
  <div class="star-312">&#9733;</div>
  <div class="star-313">&#9733;</div>
  <div class="star-314">&#9733;</div>
...
<div className="partition-container">
        {filtered.map((plumber, index) => (
          <PestControlChennaiPartition key={index} plumber={plumber} />
        ))}
      </div>
    </div>
  );
...
export default PestcontrolChennai;