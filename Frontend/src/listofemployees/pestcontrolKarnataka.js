...
import '../pages/pestcontrolKarnataka.css';
import { useDispatch, useSelector } from 'react-redux';
import { useEffect } from 'react';
import { getEmployees } from '../actions/employeesActions';
import PestControlKarnatakaPartition from '../partitions/pestcontrolKarnatakaPartition';
...
const PestcontrolKarnataka=()=>{
  ...
  const {employee_details,loading}=useSelector((state)=>
    ...
    const filtered = employee_details.filter(
      (obj) => obj.service_type === 'pestcontroller' && obj.location === 'Karnataka'
    );
...
<MetaData title={'chooseProvider'}/>
  ...
  <div className='partition-container'>
    ...
    <div className="partition-1">
             ...
             <img src="/images/pestcontrolKarnataka-1.jpg" className="image2" alt ="not found"></img>
             <span className="name">Mr.Evans</span><br></br>
             <span className="age">age:31</span><br></br>
             <div class="rating">
  <div class="star-361">&#9733;</div> 
  <div class="star-362">&#9733;</div>
  <div class="star-363">&#9733;</div>
  <div class="star-364">&#9733;</div>
  <div class="star-365">&#9733;</div>
</div>
    ...
    <div className="partition-2">
             ...
             <img src="/images/pestcontrolKarnataka-2.jpg" className="image3" alt ="not found"></img>
             <span className="name">Mr.Bruce</span><br></br>
             <span className="age">age:32</span><br></br>
             <div class="rating-2">
  <div class="star-366">&#9733;</div> 
  <div class="star-367">&#9733;</div>
  <div class="star-368">&#9733;</div>
  <div class="star-369">&#9733;</div>
  <div class="star-370">&#9733;</div>
</div>
    ...
    <div className="partition-3">
             ...
             <img src="/images/pestcontrolKarnataka-3.jpg" className="image4" alt ="not found"></img>
             <span className="name">Mr.Poorna</span><br></br>
             <span className="age">age:30</span><br></br>
             <div class="rating-3">
  <div class="star-371">&#9733;</div> 
  <div class="star-372">&#9733;</div>
  <div class="star-373">&#9733;</div>
  <div class="star-374">&#9733;</div>
  <div class="star-375">&#9733;</div>
</div>
...
<div className="partition-container">
        {filtered.map((plumber, index) => (
          <PestControlKarnatakaPartition key={index} plumber={plumber} />
        ))}
      </div>
    </div>
  );
...
export default PestcontrolKarnataka;