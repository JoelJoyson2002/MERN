...
const CleaningKarnatakaPartition = ({ plumber }) => {
...
let path=plumber.images[0].Filename.split("/");
  ...
  return (
    <div className="partition">
      {/*<img src={`/images/${plumber.images[0].Filename}`}  className="image" alt="not found" /><br></br>*/}
...
export default CleaningKarnatakaPartition;
